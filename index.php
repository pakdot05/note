                ...
                <form name="signin" method="post" onsubmit="return validateForm()">
                    <div class="wrapper-lg">
                        <div class="form-group">
                            <label class="control-label" style="font-family: 'Arial Black', Arial, sans-serif; font-size: 19px; color: white;">Email</label>
                            <input name="email" type="email" placeholder="Enter Email" class="form-control input-lg" required>
                        </div>
                        <br>
                        <div class="form-group">
                            <label class="control-label" style="font-family: 'Arial Black', Arial, sans-serif; font-size: 19px; color: white;">Password</label>
                            <input name="password" type="password" id="inputPassword" placeholder="Password" class="form-control input-lg" required>
                        </div>
                        <div class="line line-dashed"></div>
                        <button name="signin" type="submit" class="login-btn">Login</button>
                        <div class="line line-dashed"></div>
                        <p class="text-muted text-center" style="font-family: 'Arial Black', Arial, sans-serif; font-size: 25px; color: white;"><small>Do not have an account?</small></p>
